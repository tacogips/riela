...
final class RielaAppInterfaceIdentifierTests: XCTestCase {
  ...
  func testInstanceListUsesStateAndAddInstanceFlowInsteadOfEnabledDisabledSplit() throws {
    ...
    XCTAssertTrue(controllerRowSource.contains("rielaAppConfigureGroupedListScroll(scroll)"))
    XCTAssertFalse(controllerRowSource.contains("rielaAppSettingsRow(rowStack)"))
...
private extension RielaAppInterfaceIdentifierTests {
  private func assertProfileSelectUsesSettingsRows(
    ...
    XCTAssertTrue(settingsRowStyleSource.contains("row.layer?.cornerRadius = 12"))
  ...
  private func assertAddInstancePromptUsesSettingsFlow(
    ...
    XCTAssertTrue(controllerPromptSource.contains("runAddInstancePromptWindow("))
    XCTAssertTrue(controllerPromptSource.contains("title: \"Choose Workflow\""))
    XCTAssertTrue(controllerPromptSource.contains("title: \"Configure Instance\""))
    XCTAssertTrue(controllerPromptSource.contains("activeAddInstanceWindow"))
    XCTAssertFalse(controllerPromptSource.contains("NSAlert()"))
    XCTAssertFalse(controllerPromptSource.contains("runModal()"))
    XCTAssertFalse(controllerPromptSource.contains("messageText = \"Choose Workflow\""))
    XCTAssertFalse(controllerPromptSource.contains("messageText = \"Configure Instance\""))
    ...
    XCTAssertTrue(controllerPromptSource.contains("primaryTitle: \"Create\""))
    XCTAssertTrue(controllerPromptSource.contains("window.titlebarAppearsTransparent = true"))
    XCTAssertTrue(controllerPromptSource.contains("NSApp.runModal(for: window)"))
  ...
  private func assertCompactInstanceWindowAndToolbar(controllerSource: String) {
    ...
    XCTAssertTrue(controllerSource.contains("initialWindowSize = NSSize(width: 920"))
    XCTAssertTrue(controllerSource.contains("minimumWindowSize = NSSize(width: 760"))
    XCTAssertTrue(controllerSource.contains("window.titlebarAppearsTransparent = true"))
  ...
  private func assertWorkflowSourceSelectionRows(
    ...
    XCTAssertTrue(controllerPromptSource.contains("static let windowWidth: CGFloat = 560"))
