...
Run deterministically:
    ...
    RIELA_MEMORY_ROOT=./tmp/enterprise-matrix-vendor-onboarding/memory riela workflow run enterprise-matrix-vendor-onboarding --workflow-definition-dir ./examples --mock-scenario ./examples/enterprise-matrix-vendor-onboarding/mock-scenario.json --output json
