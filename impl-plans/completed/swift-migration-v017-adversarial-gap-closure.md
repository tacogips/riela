...
**Issue Reference**: GitHub issue #63, `tacogips/riela`
...
#### `packages/riela-adapters/src/cursor.ts`
...
#### `packages/riela/src/workflow/adapter.ts`
...
#### `Tests/RielaCLITests/CLIWorkflowSessionResolutionTests.swift`
...
export interface V017ParityReviewHandoff {
  ...
  readonly issueReference: "tacogips/riela#63";
...
| --- | --- | --- | --- |
| TypeScript Cursor slug and preflight parity | `packages/riela-adapters/src/cursor.ts`, `packages/riela/src/workflow/adapters/cursor.test.ts` | COMPLETED | targeted Bun cursor tests |
...
| Goal-review routing reconciliation | `packages/riela/src/workflow/adapter.ts`, `Sources/RielaCore/AdapterContracts.swift` | COMPLETED | TypeScript adapter tests and Swift adapter utility tests |
| User-scope resume resolution | `Sources/RielaCLI/*Session*`, `Sources/RielaCore/RuntimeSession.swift` | COMPLETED | Swift CLI session resolution tests |
...
**Status**: Completed
**Parallelizable**: Yes
**Deliverables**: `packages/riela-adapters/src/cursor.ts`, `packages/riela/src/workflow/adapters/cursor.test.ts`
**Dependencies**: None
...
**Status**: Completed
**Parallelizable**: Yes
**Deliverables**: `packages/riela/src/workflow/adapter.ts`, `packages/riela/src/workflow/adapter.test.ts`, `Sources/RielaCore/AdapterContracts.swift`, `Tests/RielaAdaptersTests/AdapterUtilitiesTests.swift`
**Dependencies**: None
...
**Status**: Completed
**Parallelizable**: No
**Deliverables**: `Sources/RielaCLI/CLIWorkflowSessionResolution.swift`, `Sources/RielaCLI/CLIWorkflowSessionStore.swift`, `Sources/RielaCLI/WorkflowCommands.swift`, `Sources/RielaCore/RuntimeSession.swift`, `Tests/RielaCLITests/CLIWorkflowSessionResolutionTests.swift`, `Tests/RielaCLITests/WorkflowCommandTests.swift`
...
- `bun test packages/riela/src/workflow/adapters/cursor.test.ts`
- `bun test packages/riela/src/workflow/adapter.test.ts`
- `bun run typecheck`
...
- `git diff --check -- packages/riela-adapters/src/cursor.ts packages/riela/src/workflow/adapters/cursor.test.ts packages/riela/src/workflow/adapter.ts packages/riela/src/workflow/adapter.test.ts Sources/CursorCLIAgent Sources/RielaCore/AdapterContracts.swift scripts/verify-and-update-v017-parity.sh impl-plans/active/swift-migration-v017-adversarial-gap-closure.md impl-plans/PROGRESS.json impl-plans/README.md packaging/homebrew/swift-cutover-gates.json`
