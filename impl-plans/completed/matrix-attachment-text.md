...
- `packages/riela/src/events/adapters/matrix.ts`: Matrix `/sync` lifecycle,
  normalized `chat.message` construction, history attachment, reply target, and
  diagnostic sink behavior.
- `packages/riela/src/events/adapters/matrix-attachments.ts`: new helper
...
- `packages/riela-events/src/types.ts`: `MatrixSourceConfig.attachments`
  source configuration contract.
- `packages/riela/src/events/validate-source-matrix.ts`: validation for
  `attachments.downloadText`, `attachments.maxBytes`, and
  `attachments.allowedMimeTypes`.
- `packages/riela/src/events/adapters/matrix.test.ts`: Matrix sync and
  normalization behavior coverage.
- `packages/riela/src/events/config.test.ts`: valid and malformed Matrix
  attachment configuration coverage.
- `examples/event-sources/.riela-events/sources/team-matrix.json` and
...
- `packages/riela/src/events/validate-source-matrix.ts`
...
**File Path**: `packages/riela/src/events/adapters/matrix-attachments.ts`
...
**File Path**: `packages/riela/src/events/adapters/matrix.ts`
...
| ------ | --------- | ------ | ----- |
| Config types | `packages/riela-events/src/types.ts` | COMPLETED | `packages/riela/src/events/config.test.ts` |
| Config validation | `packages/riela/src/events/validate-source-matrix.ts` | COMPLETED | `packages/riela/src/events/config.test.ts` |
| Attachment helper | `packages/riela/src/events/adapters/matrix-attachments.ts` | COMPLETED | `packages/riela/src/events/adapters/matrix.test.ts` |
| Sync integration | `packages/riela/src/events/adapters/matrix.ts` | COMPLETED | `packages/riela/src/events/adapters/matrix.test.ts` |
| Operator docs | `README.md`, `examples/event-sources/README.md` | COMPLETED | `git diff --check` |
| Source fixture | `examples/event-sources/.riela-events/sources/team-matrix.json` | COMPLETED | `bun test packages/riela/src/events/config.test.ts` |
...
**Status**: COMPLETED
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/adapters/matrix.test.ts`
...
**Status**: COMPLETED
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/adapters/matrix-attachments.ts`,
`packages/riela/src/events/adapters/matrix.test.ts`
...
**Status**: COMPLETED
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/adapters/matrix.ts`,
`packages/riela/src/events/adapters/matrix.test.ts`
...
**Status**: COMPLETED
**Parallelizable**: Yes
**Deliverables**: `examples/event-sources/.riela-events/sources/team-matrix.json`,
...
- `git diff --check -- packages/riela-events/src/types.ts packages/riela/src/events/validate-source-matrix.ts packages/riela/src/events/adapters/matrix-attachments.ts packages/riela/src/events/adapters/matrix.ts packages/riela/src/events/adapters/matrix.test.ts packages/riela/src/events/config.test.ts examples/event-sources/.riela-events/sources/team-matrix.json examples/event-sources/README.md README.md`
- `bun test packages/riela/src/events/adapters/matrix.test.ts`
- `bun test packages/riela/src/events/config.test.ts`
- `bun run typecheck`
- `bun test`
...
- `bun test packages/riela/src/events/adapters/matrix.test.ts` - passed, 13
  tests.
- `bun test packages/riela/src/events/config.test.ts` - passed, 40 tests.
