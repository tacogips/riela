...
- `packages/riela-adapters/src/codex.ts`
...
#### packages/riela-adapters/src/cursor-sdk.ts
...
#### packages/riela-addons/src/node-addons/addon-constants-and-agent-config.ts
#### packages/riela-addons/src/node-addons/gateway-and-git-config.ts
#### packages/riela-core/src/workflow-model.ts
#### packages/riela-core/src/index.ts
#### packages/riela/src/workflow/addon-types.ts
#### packages/riela/src/workflow/types.ts
#### packages/riela/src/workflow/runtime-readiness-agent-probes.ts
#### packages/riela/src/workflow/runtime-readiness.ts
...
interface TelegramSdkTrioAuthoringSurface {
  ...
  readonly routerAddon: "riela/chat-persona-router";
  readonly yuiWorkerAddon: "riela/codex-sdk-worker";
  readonly mikaWorkerAddon: "riela/claude-sdk-worker";
  readonly rinaWorkerAddon: "riela/cursor-sdk-worker";
  readonly replyAddon: "riela/chat-reply-worker";
...
#### README.md
#### package.json
#### packages/riela-adapters/package.json
#### packages/riela-adapters/src/dispatch.ts
#### packages/riela-adapters/src/index.ts
...
| Cursor SDK Bun child boundary | `packages/riela-adapters/src/cursor-sdk.ts`; `packages/riela/src/workflow/adapters/cursor-sdk.ts` | COMPLETED | `packages/riela/src/workflow/adapters/cursor-sdk.test.ts` |
| SDK worker add-on catalog and readiness | `packages/riela-addons/src/node-addons/`; `packages/riela/src/workflow/runtime-readiness*.ts` | COMPLETED | `sdk-agent-workers.test.ts`; `runtime-readiness-backends.test.ts` |
| Test gating and live smoke coverage | `packages/riela/src/workflow/adapters/*live-smoke.test.ts`; event adapter and reply-dispatch tests | COMPLETED | targeted SDK, CLI, provider-neutral chat, Codex attachment, and redaction tests |
| Telegram SDK trio and non-SDK example preservation | `examples/telegram-sdk-trio-chat/`; `examples/discord-agent-trio-chat/`; `examples/telegram-agent-trio-chat/`; `examples/matrix-agent-trio-chat/`; `examples/matrix-chat-reply/`; `examples/event-sources/.riela-events/bindings/telegram-gateway-sdk-trio-to-workflow.json` | COMPLETED | workflow and events validation |
...
bun test packages/riela/src/workflow/adapters/cursor-sdk.test.ts packages/riela/src/workflow/adapters/dispatch.test.ts packages/riela/src/workflow/node-addons/sdk-agent-workers.test.ts
bun test packages/riela/src/workflow/runtime-readiness-backends.test.ts packages/riela/src/package-boundaries.test.ts
bun test packages/riela/src/workflow/native-node-executor-addons-commands.test.ts packages/riela/src/events/adapters/discord-gateway.test.ts packages/riela/src/events/adapters/telegram-gateway.test.ts packages/riela/src/events/adapters/matrix.test.ts packages/riela/src/workflow/adapters/codex.test.ts
bun test packages/riela/src/events/matrix-chat-reply-example.test.ts packages/riela/src/events/adapters/matrix.test.ts packages/riela/src/events/reply-dispatcher.test.ts
...
```bash
bun test packages/riela/src/workflow/adapters/official-sdk-live-smoke.test.ts
bun test packages/riela/src/workflow/adapters/cli-agent-live-smoke.test.ts
bun run packages/riela/src/bin.ts events serve --workflow-definition-dir ./examples --event-root ./examples/event-sources/.riela-events
```
...
- Mid: `packages/riela-adapters/src/cursor-sdk.ts` defaulted Cursor SDK
...
- Mid: `packages/riela-adapters/src/cursor-sdk.ts` spawned the Bun child from
...
- Passed: `bun test packages/riela/src/workflow/adapters/cursor-sdk.test.ts packages/riela/src/workflow/adapters/dispatch.test.ts packages/riela/src/workflow/node-addons/sdk-agent-workers.test.ts`
- Passed: `bun run typecheck`
- Passed: `bun test packages/riela/src/workflow/runtime-readiness-backends.test.ts packages/riela/src/package-boundaries.test.ts`
- Passed: `bun test packages/riela/src/workflow/native-node-executor-addons-commands.test.ts packages/riela/src/events/adapters/discord-gateway.test.ts packages/riela/src/events/adapters/telegram-gateway.test.ts packages/riela/src/events/adapters/matrix.test.ts packages/riela/src/workflow/adapters/codex.test.ts`
- Passed: `bun test packages/riela/src/events/matrix-chat-reply-example.test.ts packages/riela/src/events/adapters/matrix.test.ts packages/riela/src/events/reply-dispatcher.test.ts`
- Passed: `bun run scripts/audit-chat-redaction-literals.ts`
- Passed with explicit skips: `bun test packages/riela/src/workflow/adapters/official-sdk-live-smoke.test.ts packages/riela/src/workflow/adapters/cli-agent-live-smoke.test.ts`
- Passed: `bun run packages/riela/src/bin.ts workflow validate discord-agent-trio-chat --workflow-definition-dir ./examples`
- Passed: `bun run packages/riela/src/bin.ts workflow validate telegram-sdk-trio-chat --workflow-definition-dir ./examples`
- Passed: `bun run packages/riela/src/bin.ts workflow validate telegram-agent-trio-chat --workflow-definition-dir ./examples`
- Passed: `bun run packages/riela/src/bin.ts workflow validate matrix-agent-trio-chat --workflow-definition-dir ./examples`
- Passed: `bun run packages/riela/src/bin.ts workflow validate matrix-chat-reply --workflow-definition-dir ./examples`
- Passed: `bun run packages/riela/src/bin.ts events validate --workflow-definition-dir ./examples --event-root ./examples/event-sources/.riela-events`
...
- Low: `packages/riela-adapters/src/cursor-sdk.ts` normalized Cursor SDK
...
- Low: `packages/riela-adapters/src/cursor-sdk.ts` did not explicitly cancel
...
- Low: `packages/riela/src/events/adapters/matrix.test.ts` contained a
...
- Passed with explicit skips: `bun test packages/riela/src/workflow/adapters/official-sdk-live-smoke.test.ts packages/riela/src/workflow/adapters/cli-agent-live-smoke.test.ts`
  ...
  live smoke tests because credentials or `RIELA_RUN_CLI_AGENT_LIVE_SMOKE=1`
  were not configured.
- Passed: `bun run typecheck`
- Passed: `bun run lint:biome`
- Passed: `bun run build`
