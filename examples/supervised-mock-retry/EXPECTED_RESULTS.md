...
Regression coverage for stall, patch escalation, and budgets lives in `packages/riela/src/workflow/engine.test.ts` and `packages/riela/src/workflow/superviser.test.ts`.
