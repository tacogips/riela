...
| ---- | --------: | ------ | ---------- |
| `active/workflow-defect-detection-and-repair` | 6 | Design and plan independently accepted 2026-09-22 (`1669d40`); six serial tasks for routing contracts, cycle analysis, persisted progress and verified repairs; no implementation | Workflow correctness |
