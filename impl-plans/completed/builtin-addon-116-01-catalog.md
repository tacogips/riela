...
```json
{
  ...
  "planPath": "impl-plans/completed/builtin-addon-116-01-catalog.md",
  "dependsOn": [],
  "writePaths": [
    ...
    "impl-plans/completed/builtin-addon-116-01-catalog-progress.md"
  ],
  "sharedPaths": [],
  "progressLog": "impl-plans/completed/builtin-addon-116-01-catalog-progress.md"
}
```
