...
- Review finding: mid severity at
  `packages/riela/src/workflow/native-node-executor-gateway.test.ts:684`
...
- Changing package skill projection code or tests in
  `packages/riela/src/workflow/packages/skill-install.ts` or
...
| --- | --- | --- | --- |
| Native `.bash` regression fixture | `packages/riela/src/workflow/native-node-executor-gateway.test.ts` | COMPLETED | `bun test packages/riela/src/workflow/native-node-executor-gateway.test.ts` |
...
- Read around
  `packages/riela/src/workflow/native-node-executor-gateway.test.ts:33`
  and `packages/riela/src/workflow/native-node-executor-gateway.test.ts:684`.
...
- [x] `bun test packages/riela/src/workflow/native-node-executor-gateway.test.ts`
      passes.
...
| TASK-002 | TASK-001 | `packages/riela/src/workflow/native-node-executor-gateway.test.ts` | COMPLETED |
