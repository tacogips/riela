...
Run deterministically:
    ...
    RIELA_MEMORY_ROOT=./tmp/enterprise-matrix-security-incident/memory riela workflow run enterprise-matrix-security-incident --workflow-definition-dir ./examples --mock-scenario ./examples/enterprise-matrix-security-incident/mock-scenario.json --output json
