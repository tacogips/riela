...
- `fetch-latest-gmail` does not request raw `textBody`, `htmlBody`, or file payloads in GraphQL; it requests vendor-neutral file and attachment metadata plus `downloadKey` values for later out-of-band download.
