...
final class AddonExecutionContractsTests: XCTestCase {
  ...
  func testBuiltinCatalogContainsNoteAddons() {
    ...
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/kv-set", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/kv-get", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/kv-delete", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/kv-list", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/kv-set", version: nil))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/kv-set", version: "2"))
    ...
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-service-gateway-read", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-service-gateway-write", version: "1"))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/google-service-gateway-read", version: "2"))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/wrike-gateway-read", version: "2"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/gmail-gateway-reader", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/gmail-gateway-draft", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/gmail-gateway-sender", version: "1"))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/gmail-gateway-reader", version: "2"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-analytics-gateway-read", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-analytics-gateway-write", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-analytics-gateway-admin", version: "1"))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/google-analytics-gateway-read", version: "2"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-docs-gateway-read", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-docs-gateway-write", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-sheet-gateway-read", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-sheet-gateway-write", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-drive-gateway-read", version: "1"))
    XCTAssertTrue(RielaBuiltinAddonCatalog.supports(name: "riela/google-drive-gateway-write", version: "1"))
    XCTAssertFalse(RielaBuiltinAddonCatalog.supports(name: "riela/google-drive-gateway-write", version: "2"))
    ...
    XCTAssertEqual(RielaBuiltinAddonCatalog.noteAddons.count, 19)
  }
