...
final class NativeBundleAddonContractsTests: XCTestCase {
  ...
  func testDynamicLibraryLoaderBuildsCABIHandleFromRequiredSymbols() async throws {
    ...
    XCTAssertEqual(verifier.verifiedRequirements(), ["identifier \"com.example.riela.NativeRunner\""])
    XCTAssertEqual(nativeBundleCStringRegistry.freedCount(), 2)
  }
  ...
  private func registration(
    ...
    codeSignatureRequirement: NativeBundleCodeSignatureRequirement? = NativeBundleCodeSignatureRequirement("identifier \"com.example.riela.NativeRunner\""),
    bundleIdentifier: String = "com.example.riela.NativeRunner"
...
private struct CacheTestPluginHandle: NativeBundlePluginHandle {
  ...
  func loadDescriptor() async throws -> NativeBundleAddonDescriptor {
    NativeBundleAddonDescriptor(abiVersion: 1, bundleIdentifier: "com.example.riela.NativeRunner", exports: [])
  }
