...
- `.agents/skills/riela-event-sources/SKILL.md`: event validation, serve,
  list, replay, receipts, and read-only behavior.
- `.agents/skills/riela-impl-workflow/SKILL.md`: issue-resolution workflow
  context.
- `codex-agent`: referenced only as a possible workflow node backend.
  Sequencing remains provider-neutral and is owned by riela events.
...
#### packages/riela-events/src/types.ts
#### packages/riela/src/events/config.ts
...
#### packages/riela/src/events/adapters/sequential-list.ts
#### packages/riela/src/events/sequential-list-state.ts
...
#### packages/riela/src/events/trigger-runner.ts
#### packages/riela/src/events/trigger-runner/trigger-dispatch-runner.ts
#### packages/riela/src/events/sequential-list-completion.ts
...
#### packages/riela/src/events/ledger.ts
#### packages/riela/src/events/receipt-ops.ts
#### packages/riela/src/workflow/runtime-db/event-records.ts
#### packages/riela/src/workflow/runtime-db/schema-and-record-types.ts
...
- [x] Add a runnable sequential-list source fixture under
      `examples/event-sources/.riela-events/sources/`.
...
- [x] Keep examples usable with
      `--workflow-definition-dir ./examples --event-root ./examples/event-sources/.riela-events`.
...
| --- | --- | --- | --- |
| Config types and validation | `packages/riela-events/src/types.ts`, `packages/riela/src/events/validate.ts` | COMPLETED | `validate-source-sequential-list.test.ts` |
| Sequence state and adapter | `packages/riela/src/events/adapters/sequential-list.ts`, `packages/riela/src/events/sequential-list-state.ts` | COMPLETED | `adapters/sequential-list.test.ts` |
| Dispatch completion gate | `packages/riela/src/events/listener-service.ts`, `packages/riela/src/events/sequential-list-completion.ts` | COMPLETED | `listener-service.test.ts`, `adapters/sequential-list.test.ts`, `sequential-list-completion.test.ts` |
...
**Status**: Completed
**Parallelizable**: No
**Deliverables**: `packages/riela-events/src/types.ts`, `packages/riela/src/events/config.ts`, `packages/riela/src/events/validate.ts`, `packages/riela/src/events/validate-source-sequential-list.ts`, `packages/riela/src/events/validate-source-sequential-list.test.ts`
**Dependencies**: None
...
**Status**: Completed
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/adapters/sequential-list.ts`, `packages/riela/src/events/sequential-list-state.ts`, `packages/riela/src/events/adapter-registry.ts`, `packages/riela/src/events/adapters/sequential-list.test.ts`, `packages/riela/src/events/adapter-registry.test.ts`
...
**Status**: Completed
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/source-adapter.ts`, `packages/riela/src/events/listener-service.ts`, `packages/riela/src/events/sequential-list-completion.ts`, `packages/riela/src/events/trigger-runner/trigger-dispatch-runner.ts`, `packages/riela/src/events/listener-service.test.ts`
...
**Status**: Completed
**Parallelizable**: No
**Deliverables**: `packages/riela/src/events/ledger.ts`, `packages/riela/src/events/receipt-ops.ts`, `packages/riela/src/workflow/runtime-db/event-records.ts`, `packages/riela/src/workflow/runtime-db/schema-and-record-types.ts`, `packages/riela/src/cli.ts`, `packages/riela/src/events/receipt-ops.test.ts`, `packages/riela/src/cli.test.ts`
...
**Status**: Completed
**Parallelizable**: Yes
**Deliverables**: `examples/event-sources/.riela-events/sources/sequential-list.json`, `examples/event-sources/.riela-events/bindings/sequential-list-to-arithmetic.json`, `examples/event-sources/README.md`, `README.md`
...
- [x] Read-only sequential-list verification passes with
      `RIELA_EVENTS_READ_ONLY=true` or `--read-only`.
...
- `bun run typecheck`
- `bun test packages/riela/src/events/validate-source-sequential-list.test.ts packages/riela/src/events/adapter-registry.test.ts packages/riela/src/events/adapters/sequential-list.test.ts packages/riela/src/events/sequential-list-completion.test.ts packages/riela/src/events/listener-service.test.ts packages/riela/src/events/receipt-ops.test.ts packages/riela/src/cli.test.ts`
...
- `RIELA_EVENTS_READ_ONLY=true bun test packages/riela/src/events/adapters/sequential-list.test.ts`
- `bun run packages/riela/src/bin.ts events list --event-root ./examples/event-sources/.riela-events`
