...
| ---- | --------: | ------ | ---------- |
| `active/workflow-defect-detection-and-repair` | 6 | Historical D1–D8 accepted per intake; current D1–D9 design accepted by Step 3 (`comm-000004`, 2026-09-23); exact final plan Step 5 review pending; six serial tasks including backend liveness remain unimplemented | Workflow correctness |
